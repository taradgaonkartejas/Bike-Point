...
public class GarageController {
	...
	@GetMapping("/login")
	public ResponseEntity<?> authenticateGarage(@RequestParam String email, @RequestParam String password){
		GarageDto garage= garageSer.authenticateGarage(email, password);
		if (garage != null) {
