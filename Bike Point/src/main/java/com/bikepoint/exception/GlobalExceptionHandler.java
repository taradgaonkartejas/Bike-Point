...
//on ret types of all exception handling methods 
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
		...
		Map<String, String> map = fieldErrors.stream()// stream of feild errors
	...
	public ApiResponse IllegalArgumentException(IllegalArgumentException e) {
		System.out.println("in Illegeal Agrument " + e);
		return new ApiResponse(e.getMessage());
	}
