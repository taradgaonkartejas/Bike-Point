...
export default function CustomerSignup() {
 ...
 let navigate=useNavigate();
  ...
  return (
    <>
    {/* <!----------------------- Main Container --------------------------> */}
    <Form className="container d-flex justify-content-center align-items-center my-3 w-50 " onSubmit={submitForm}>
        {/* <!----------------------- Login Container --------------------------> */}
                            ...
                            <div className="row">
                                <div className="col">
                                    <div className="form-floating mb-3">
                                        ...
                                        id="address" rows="5" placeholder="" value={data.address} onChange={(e)=>{handelChange(e , 'address')}}
                                        invalid={error.errors?.response?.data?.address ? true:undefined}></Input>
