                                    ...
                                    <div className="col-md-12 right-box">
                                        ...
                                        <div className="row ">
                                            <div className="col fs-6">
                                                <div className="form-floating mb-3">
                                                    <Input type='textarea' className="form-control" id="address" rows="4" placeholder=""
                                                ...
                                                <div className="input-group">
                                                    <button type='reset' className="btn btn-lg btn-secondary w-100 fs-6" onClick={resetGarageData}>Reset</button>
