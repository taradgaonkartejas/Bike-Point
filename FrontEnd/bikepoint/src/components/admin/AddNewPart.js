                            ...
                            <div className="row">
                                ...
                                <div className="row mb-3">
                                    ...
                                    <div className="input-group ">
                                        <Input type='select' className="form-select mb-3" id='companyName' 
                                        value={part.companyName} onChange={(e) => { handelChange(e, 'companyName') }}
                                        invalid={error.errors?.response?.data?.companyName ? true : undefined}>
                                        ...
                                        <FormFeedback>
                                                {error.errors?.response?.data?.companyName}
                                            </FormFeedback>
